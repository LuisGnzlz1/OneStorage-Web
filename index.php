            ...
            <div class="form-contact mx-auto">
                ...
                <form id="contact-form-r" role="form">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input id="c-nombre-r" type="text" name="c-nombre-r" class="form-control" placeholder="Ingrese su nombre">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input id="c-mail-r" type="text" name="c-mail-r" class="form-control" placeholder="Ingrese su correo">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea id="c-mensaje-r" name="c-mensaje-r" class="form-control" placeholder="Ingrese un mensaje" rows="4"></textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" id="btn-send-mensaje-r" class="btn btn-green btn-send btn-block">
                                Enviar mensaje
                            </button>
                        </div>
                    </div>
